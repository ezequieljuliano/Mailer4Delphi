...
begin
  case errorCode of
    MAPI_E_FAILURE:
      raise EMapiMailerException.Create('Error sending email: MAPI_E_FAILURE!');
    MAPI_E_LOGON_FAILURE:
      raise EMapiMailerException.Create('Error sending email: MAPI_E_LOGON_FAILURE!');
    MAPI_E_DISK_FULL:
      raise EMapiMailerException.Create('Error sending email: MAPI_E_DISK_FULL!');
    MAPI_E_INSUFFICIENT_MEMORY:
      raise EMapiMailerException.Create('Error sending email: MAPI_E_INSUFFICIENT_MEMORY!');
    MAPI_E_ACCESS_DENIED:
      raise EMapiMailerException.Create('Error sending email: MAPI_E_ACCESS_DENIED!');
    MAPI_E_TOO_MANY_SESSIONS:
      raise EMapiMailerException.Create('Error sending email: MAPI_E_TOO_MANY_SESSIONS!');
    MAPI_E_TOO_MANY_FILES:
      raise EMapiMailerException.Create('Error sending email: MAPI_E_TOO_MANY_FILES!');
    MAPI_E_TOO_MANY_RECIPIENTS:
      raise EMapiMailerException.Create('Error sending email: MAPI_E_TOO_MANY_RECIPIENTS!');
    MAPI_E_ATTACHMENT_NOT_FOUND:
      raise EMapiMailerException.Create('Error sending email: MAPI_E_ATTACHMENT_NOT_FOUND!');
    MAPI_E_ATTACHMENT_OPEN_FAILURE:
      raise EMapiMailerException.Create('Error sending email: MAPI_E_ATTACHMENT_OPEN_FAILURE!');
    MAPI_E_ATTACHMENT_WRITE_FAILURE:
      raise EMapiMailerException.Create('Error sending email: MAPI_E_ATTACHMENT_WRITE_FAILURE!');
    MAPI_E_UNKNOWN_RECIPIENT:
      raise EMapiMailerException.Create('Error sending email: MAPI_E_UNKNOWN_RECIPIENT!');
    MAPI_E_BAD_RECIPTYPE:
      raise EMapiMailerException.Create('Error sending email: MAPI_E_BAD_RECIPTYPE!');
    MAPI_E_NO_MESSAGES:
      raise EMapiMailerException.Create('Error sending email: MAPI_E_NO_MESSAGES!');
    MAPI_E_INVALID_MESSAGE:
      raise EMapiMailerException.Create('Error sending email: MAPI_E_INVALID_MESSAGE!');
    MAPI_E_TEXT_TOO_LARGE:
      raise EMapiMailerException.Create('Error sending email: MAPI_E_TEXT_TOO_LARGE!');
    MAPI_E_INVALID_SESSION:
      raise EMapiMailerException.Create('Error sending email: MAPI_E_INVALID_SESSION!');
    MAPI_E_TYPE_NOT_SUPPORTED:
      raise EMapiMailerException.Create('Error sending email: MAPI_E_TYPE_NOT_SUPPORTED!');
    MAPI_E_AMBIGUOUS_RECIPIENT:
      raise EMapiMailerException.Create('Error sending email: MAPI_E_AMBIGUOUS_RECIPIENT!');
    MAPI_E_MESSAGE_IN_USE:
      raise EMapiMailerException.Create('Error sending email: MAPI_E_MESSAGE_IN_USE!');
    MAPI_E_NETWORK_FAILURE:
      raise EMapiMailerException.Create('Error sending email: MAPI_E_NETWORK_FAILURE!');
    MAPI_E_INVALID_EDITFIELDS:
      raise EMapiMailerException.Create('Error sending email: MAPI_E_INVALID_EDITFIELDS!');
    MAPI_E_INVALID_RECIPS:
      raise EMapiMailerException.Create('Error sending email: MAPI_E_INVALID_RECIPS!');
    MAPI_E_NOT_SUPPORTED:
      raise EMapiMailerException.Create('Error sending email: MAPI_E_NOT_SUPPORTED!');
  end;
end;
